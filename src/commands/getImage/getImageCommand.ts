...
async function getImage(interaction: ChatInputCommandInteraction, link: string, animal: string) {
...
export async function getImageCommand(interaction: ChatInputCommandInteraction) {
